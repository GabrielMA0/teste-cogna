...
export function CardSolutions({title, description, icon, slug, audience, emphasis}: CardSolutionsProps) {
    return(
        <div className={`w-102.5 h-95 bg-white flex flex-col gap-4 p-10 rounded-[24] border-b-[5px] shadow-[0_4px_20px_rgba(0,0,0,0.2)] ${emphasis ? 'border-secondary' : 'border-primary'}`}>
